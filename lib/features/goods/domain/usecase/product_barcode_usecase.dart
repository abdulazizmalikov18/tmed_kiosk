...
class ProductBarCodeUseCase extends UseCase<OrgProductEntity, String> {
  final GoodsRepoImpl repository = serviceLocator<GoodsRepoImpl>();

  @override
  Future<Either<Failure, OrgProductEntity>> call(String params) async =>
      await repository.getProductBarCode(params);
}
