...
SpecialistOrderModel _$SpecialistOrderModelFromJson(
    ...
    SpecialistOrderModel(
      ...
      lastOrderNumber: json['last_order_number'] as int? ?? 0,
      patientNumber: json['patient_number'] as int? ?? 0,
      lastPatientNumber: json['last_patient_number'] as int? ?? 0,
      specialist: json['specialist'] as int? ?? 0,
    );
