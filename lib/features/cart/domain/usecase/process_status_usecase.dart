...
class ProcessStatusUseCase
    extends UseCase<GenericPagination<ProcessStatusEntity>, NoParams> {
  final CartRepo repository = serviceLocator<CartRepoImpl>();

  @override
  Future<Either<Failure, GenericPagination<ProcessStatusEntity>>> call(
          NoParams params) async =>
      await repository.processStatus();
}
